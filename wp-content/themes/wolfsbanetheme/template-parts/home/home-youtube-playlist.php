<div class="o-page-layout__video">
                <div id="c-video-youtube-player" class="c-video">
                            ...
                            <li class="c-medialist__media">
                                ...
                                <div class="c-medialist__controls">
                                    ...
                                    <div class="c-medialist__progress">
                                        <svg class="c-medialist__progress-instance" xmlns:svg="http://www.w3.org/2000/svg"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0"
                                            width="32px" height="11px" viewBox="0 0 128 44" xml:space="preserve">
                                    ...
                                    <div class="c-medialist__buffering">
                                        <svg class="c-medialist__buffering-instance" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" width="31px" height="31px" viewBox="0 0 128 128"
                                            xml:space="preserve">
                                            <script type="text/ecmascript" xlink:href="js/smil.user.js" />
                                            <g>
                    ...
                    <div class="c-video__screen">
                        <div class="c-video__screen-aspect-ratio-box">
                            <div class="c-video__screen-aspect-ratio-box-inner">
                                <div id="home-youtubelist-video-frame-placeholder"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="youtube-works-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
